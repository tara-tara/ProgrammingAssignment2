...
## has already been calculated, and if so, it will retrieve the inverse (via the 
## getinverse function) and return the inverse from the cache directly.
## If the inverse has not been calculated, is computes the inverse (via the solve function)  
